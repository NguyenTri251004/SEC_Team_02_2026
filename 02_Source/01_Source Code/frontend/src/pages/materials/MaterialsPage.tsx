    ...
    () => [
      ...
      columnHelper.accessor("specification_document", {
        ...
        cell: (info) => {
          const val = info.getValue();
          return val ? (
            <div className="flex items-center gap-1.5 text-xs text-blue-600 hover:underline cursor-pointer">
    ...
    <div className="p-6 relative">
      ...
      <div className="mb-6 relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-shadow"
        />
      </div>
              ...
              {table.getHeaderGroups().map((hg) => (
                <tr key={hg.id}>
                  {hg.headers.map((h) => (
                    <th
                      key={h.id}
                      className="p-4 font-semibold text-gray-600 text-xs uppercase tracking-wider"
                    >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 bg-gray-50 sm:px-6">
          <div className="flex flex-1 justify-between sm:hidden">
            <button
              ...
              className="disabled:cursor-not-allowed hover:cursor-pointer relative inline-flex items-center rounded-l-md px-4 py-2 text-sm font-medium text-white bg-gray-800 hover:bg-gray-700 disabled:bg-gray-300 disabled:text-gray-500 transition-colors focus:z-20 border-r border-gray-700"
            >
              Previous
            </button>
            <button
              ...
              className="disabled:cursor-not-allowed hover:cursor-pointer relative inline-flex items-center rounded-r-md px-4 py-2 text-sm font-medium text-white bg-gray-800 hover:bg-gray-700 disabled:bg-gray-300 disabled:text-gray-500 transition-colors focus:z-20 border-l border-gray-700"
            >
              Next
            </button>
          </div>
        ...
        initialData={
          editingMaterial
            ? {
                ...
                specification_document:
                  editingMaterial.specification_document || "",
              }
            : null
        }
      />
